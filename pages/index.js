...
export default function Home() {
  return (
    <>
      <Head>
        <title>FD Infinity - Worlds leading crypto hedgefund </title>
        <meta
          name="description"
          content="FD Infinity - Worlds leading crypto hedgefund "
        />
      ...
      <Hero />
      <SectionTitle
        pretitle="FD Infinity's Benefits"
        title=" Why you should choose us?">
        FD Infinity is asia's first crypto hedge fund,
